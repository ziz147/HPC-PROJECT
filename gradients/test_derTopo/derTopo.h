...
void der_NURBS(ListOfVectors local_support , Matrix BF_support , Vector IND_mask_active , Matrix IND_mask, Matrix IND_mask_tot ,Vector rho_e, Matrix P_rho , Matrix W, int DIM, Matrix* der_CP, Matrix* der_W, Vector* BF_mask);
